...
{
    /// <inheritdoc />
    public partial class IdentityAndStaffSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhotoObjectKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationUsers_StaffMembers_StaffMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffInvitations_StaffMembers_StaffMemberId",
                        column: x => x.StaffMemberId,
                        principalTable: "StaffMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_StaffMemberId",
                table: "ApplicationUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffInvitations_StaffMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_EmailAddress",
                table: "StaffMembers",
                column: "EmailAddress",
                unique: true);
